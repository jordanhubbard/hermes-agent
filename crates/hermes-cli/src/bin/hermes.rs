...
use hermes_cli::launcher::{
    ...
    is_rust_logs_request, is_rust_plugins_request, is_rust_profile_request,
...
use hermes_cli::{
    ...
    resolve_rust_profile_context, run_logs_command, run_plugins_command, set_active_profile,
